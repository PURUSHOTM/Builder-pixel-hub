    ...
    const invoicesData = [
      {
        ...
        items: [
          {
            ...
            quantity: 1,
            rate: 2500,
            amount: 2500, // Will be recalculated by pre-save middleware
          },
          {
        ...
        subtotal: 5000, // Will be recalculated by pre-save middleware
        taxRate: 8.5,
        taxAmount: 425, // Will be recalculated by pre-save middleware
        total: 5425, // Will be recalculated by pre-save middleware
        currency: "USD",
        status: "paid",
